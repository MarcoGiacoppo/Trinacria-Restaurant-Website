            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="pastaFilterFoodBtn" name="pastaFilterFoodBtn" class="menu-tab-item"
                            value="pasta" @click="filterFoodBtn($event)" />
                        <input type="button" id="seafoodFilterFoodBtn" name="seafoodFilterFoodBtn" class="menu-tab-item"
                            value="seafood" @click="filterFoodBtn($event)" />
